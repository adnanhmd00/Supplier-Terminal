        ...
        <body>
            ...
            <section id="content">
                <div id="main">
                    ...
                    <ul class="tabs full-width col-md-3">
                            <li class="active"><a href="#hotel" data-toggle="tab" aria-expanded="false"><i class="fa fa-hotel"></i>HOTELS</a></li>
                            <li class=""><a href="#flight" data-toggle="tab" aria-expanded="false"><i class="fa fa-plane"></i>FLIGHT</a></li>
                            <li class=""><a href="#package" data-toggle="tab" aria-expanded="false"><i class="fa fa-car"></i>PACKAGES</a></li>
                            <li class=""><a href="#experiences" data-toggle="tab" aria-expanded="false"><i class="fa fa-bookmark"></i>EXPERIENCES</a></li>
                            <li class=""><a href="#transfers" data-toggle="tab" aria-expanded="false"><i class="fa fa-calendar"></i>TRANSFERS</a></li>
                            <!-- <li class=""><a href="#flight-status-tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-plane"></i>FLIGHT STATUS</a></li> -->
                        </ul>
                    </div>
                    <br><hr>
                    <div>
                            <!-- <li style="width: 150px;" class="active"><a data-toggle="tab" href="#hotel"><i class="fa fa-hotel"></i>Hotel</a></li>

                            <li style="width: 150px;" class=""><a data-toggle="tab" href="#flight"><i class="fa fa-fighter-jet"></i>Flights</a></li>
                            <li style="width: 150px;" class=""><a data-toggle="tab" href="#package"><i class="fa fa-bookmark"></i>Packages</a></li>
                            <li style="width: 150px;" class=""><a data-toggle="tab" href="#experiences"><i class="fa fa-magic"></i>Experiences</a></li>
                            <li style="width: 150px;" class=""><a data-toggle="tab" href="#transfers"><i class="fa fa-car"></i>Transfers</a></li> -->
                        </ul>
                    <div class="tab-content">
                    <div id="hotel" class="tab-pane fade in active ">
                    <?php include('supplier-hotel.php'); ?>
                    </div>

                    <div id="flight" class="tab-pane fade in">
                    <?php include('supplier-flight.php'); ?>
                    </div>
                    
                    <div id="package" class="tab-pane fade">
                    <?php include('supplier-packages.php'); ?>
                    </div>

                    <div id="experiences" class="tab-pane fade">
                    <?php include('supplier-experiences.php'); ?>
                    </div>

                    <div id="transfers" class="tab-pane fade">
                    <?php include('supplier-transfers.php'); ?>
                    </div>
