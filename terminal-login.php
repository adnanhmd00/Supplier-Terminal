...
if (!isset($_SESSION['supplier_id'])) {
  if (isset($_POST['vlogin'])) {
    ...
    $result = mysqli_query($con, "SELECT * From partner where supplier_id='$supplier_id' && supplier_pass='$supplier_pass'");
...
<div class="bgimg" id="section1">
      ...
      <div class="person-information">
        ...
        <div class="form-group row">
          <div class="col-sm-6 col-md-6">
            ...
            <input type="text" name="supplier_id" class="input-text full-width" value="" placeholder="Enter Your Supplier ID">
          </div>
          <div class="col-sm-6 col-md-6">
            <label>Password</label>
            <input type="password" name="supplier_pass" class="input-text full-width" value="" placeholder="Password">
          </div>
        </div>
        ...
        <button type="submit" name="vlogin" class="button btn-medium sky-blue1 uppercase">GET ONBOARD</button>
        <br><br>
        <div>Not a Verified Supplier ? <a href="http://supplier.thetravelsquare.in/supplier-verification-form.php"><b>Apply Now</b></a></div>
        <br>
      </div>
      <br>
    </form>
  ...
  <div class="bottomleft">
    <a href="">
      <p><small>BACK | FORGOT PASSWORD | SUPPLIER HELP</small></p>
    </a>
  </div>
