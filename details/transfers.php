...
<?php
                                $lid=$_GET['lid'];					
                                $resultset=mysqli_query($con,"SELECT * From supplier_cab where id='$lid'");
...
<!DOCTYPE html>
    <html>
        <head>
            ...
            <!-- Page Title -->
            <title>Transfers Details | The Travel Square</title>
            <!-- Meta Tags -->
            <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <div class="page-title-container">
                <div class="container">
                    <div class="page-title pull-left">
                        <h2 class="entry-title">Transfers Details</h2>
                    </div>
                </div>
            </div>
<section id="content">
                        ...
                        <div class="travelo-box booking-section">
                            <form method="POST" class="booking-form">
                                <div class="person-information">
                                    <h1>Transfers Cab Form</h1>
                                    <div class="form-group row">
										
										<div class="col-sm-6 col-md-5">
                                            <label>Cab From City</label>
                                            <input type="text" name="from_city" class="input-text full-width" value="<?php echo $from_city ?>" placeholder="Enter The City Name" required>
                                        </div>
										<div class="col-sm-6 col-md-5">
                                            <label>Cab To City</label>
                                            <input type="text" name="to_city" class="input-text full-width" value="<?php echo $to_city ?>" placeholder="Enter The City Name" required> 
                                        </div>
										<div class="col-sm-6 col-md-5">
                                            <label>Cab Image Url</label>
                                            <input type="text" name="car_img" class="input-text full-width" value="<?php echo $car_img ?>" placeholder="Paste image url" required>
                                        </div>
										<div class="col-sm-6 col-md-5">
                                            <label>Cab Name</label>
                                            <input type="text" name="car_name" class="input-text full-width" value="<?php echo $car_name ?>" placeholder="Cab Name" required>
                                        </div>
										<div class="col-sm-6 col-md-5">
                                            <label>No. Of Seats</label>
                                            <input type="text" name="seats" class="input-text full-width" value="<?php echo $seats ?>" placeholder="Number Of Seats" required>
                                        </div>
									...
									<div class="form-group row">
										<div class="col-sm-6 col-md-5">
                                            ...
                                            <input type="text" name="price_km" class="input-text full-width" value="<?php echo $price_km ?>" placeholder="Price Per Km" required>
                                        </div>
                                        <div class="col-sm-6 col-md-5">
                                            <label>Total Price</label>
                                            <input type="text" name="pkg_price" class="input-text full-width" value="<?php echo $total_price ?>" placeholder="Total Price" required>
                                        </div>
