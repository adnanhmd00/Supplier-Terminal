...
<table class="table">
    ...
    <tbody>
    <?php 
        $table = mysqli_query($con, "SELECT * FROM supplier_flight WHERE supplier_id = '$supplier_id'");
    ...
    ?>
            ...
            <td><a href="details/flight.php?lid=<?php echo $row['id']; ?>"><button class="btn btn-primary"> Show Details</button></a></td>
