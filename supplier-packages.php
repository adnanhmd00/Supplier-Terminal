...
<table class="table">
    ...
    <tbody>
    <?php 
        $table = mysqli_query($con, "SELECT * FROM supplier_packages WHERE supplier_id = '$supplier_id'");
    ...
    ?>
            ...
            <td data-target="pkg_price"><?php echo $row['pkg_price'] ?></td>
            <td><a href="#" data-role="update" data-id="<?php echo $row['id']; ?>"><button class="btn btn-primary"> Update</button></a></td>
            <td><a href="details/packages.php?lid=<?php echo $row['id']; ?>"><button class="btn btn-primary"> Show Details</button></a></td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <label>Price</label>
            <input type="text" id="pkg_price" value="<?php echo $row['pkg_price'] ?>" class="form-control">
...
$(document).ready(function(){
    $(document).on('click','a[data-role=update]',function(){
        var id = $(this).data('id');
        var pkg_price = $('#'+id).children('td[data-target=pkg_price]').text();
    ...
    $('#save').click(function(){
        ...
        $.ajax({
            url:        'connection.php',
            method:     'POST',
            data:       {pkg_price: pkg_price, id: id},
            success:    function(response){
                            $('#'+id).children('td[data-target=pkg_price]').text(pkg_price);
                            $('#myModal2').modal('toggle');
                        }
        });
    });
