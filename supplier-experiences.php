...
<table class="table">
    ...
    <tbody>
    <?php 
        $table = mysqli_query($con, "SELECT * FROM supplier_activity WHERE supplier_id = '$supplier_id'");
    ...
    ?>
            ...
            <td><a href="details/experiences.php?lid=<?php echo $row['id']?>"><button class="btn btn-primary"> Show Details</button></a></td>
        </tr>
        <?php
        }
        ?>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <label>Price</label>
            <input type="text" id="cost" value="<?php echo $row['cost'] ?>" class="form-control">
